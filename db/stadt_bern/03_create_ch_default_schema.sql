CREATE SCHEMA ch_default
  AUTHORIZATION av_chenyx06_stadt_be_superadmin;

GRANT USAGE ON SCHEMA ch_default TO av_chenyx06_stadt_be_user;
GRANT USAGE ON SCHEMA ch_default TO av_chenyx06_stadt_be_admin;
GRANT USAGE ON SCHEMA ch_default TO av_chenyx06_stadt_be_superadmin;
...
ALTER TABLE ch_default.tsp_lv03 OWNER TO av_chenyx06_stadt_be_superadmin;
GRANT SELECT ON ch_default.tsp_lv03 TO av_chenyx06_stadt_be_user;
...
ALTER TABLE ch_default.tsp_lv95 OWNER TO av_chenyx06_stadt_be_superadmin;
GRANT SELECT ON ch_default.tsp_lv95 TO av_chenyx06_stadt_be_user;
...
ALTER TABLE ch_default.dreiecke_lv03_bearbeitung OWNER TO av_chenyx06_stadt_be_superadmin;
GRANT SELECT ON ch_default.dreiecke_lv03_bearbeitung TO av_chenyx06_stadt_be_user;
...
ALTER TABLE ch_default.dreiecke_lv95_bearbeitung OWNER TO av_chenyx06_stadt_be_superadmin;
GRANT SELECT ON ch_default.dreiecke_lv95_bearbeitung TO av_chenyx06_stadt_be_user;
...
ALTER TABLE ch_default.dreiecke OWNER TO av_chenyx06_stadt_be_superadmin;
GRANT SELECT ON ch_default.dreiecke TO av_chenyx06_stadt_be_user;
...
ALTER TABLE ch_default.dreiecke_lv03_v OWNER TO av_chenyx06_stadt_be_superadmin;
GRANT SELECT ON TABLE ch_default.dreiecke_lv03_v TO av_chenyx06_stadt_be_user;
...
ALTER TABLE ch_default.dreiecke_lv95_v OWNER TO av_chenyx06_stadt_be_superadmin;
GRANT SELECT ON TABLE ch_default.dreiecke_lv95_v TO av_chenyx06_stadt_be_user;
