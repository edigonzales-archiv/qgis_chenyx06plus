...
GRANT USAGE ON SCHEMA ch_default TO USER;
GRANT USAGE ON SCHEMA ch_default TO ADMIN;
GRANT USAGE ON SCHEMA ch_default TO SUPERADMIN;
...
ALTER TABLE ch_default.tsp_lv03 OWNER TO SUPERADMIN;
GRANT SELECT ON ch_default.tsp_lv03 TO USER;
...
ALTER TABLE ch_default.tsp_lv95 OWNER TO SUPERADMIN;
GRANT SELECT ON ch_default.tsp_lv95 TO USER;
...
ALTER TABLE ch_default.dreiecke_lv03_bearbeitung OWNER TO SUPERADMIN;
GRANT SELECT ON ch_default.dreiecke_lv03_bearbeitung TO USER;
...
ALTER TABLE ch_default.dreiecke_lv95_bearbeitung OWNER TO SUPERADMIN;
GRANT SELECT ON ch_default.dreiecke_lv95_bearbeitung TO USER;
...
ALTER TABLE ch_default.dreiecke OWNER TO SUPERADMIN;
GRANT SELECT ON ch_default.dreiecke TO USER;
...
ALTER TABLE ch_default.dreiecke_lv03_v OWNER TO SUPERADMIN;
GRANT SELECT ON TABLE ch_default.dreiecke_lv03_v TO USER;
...
ALTER TABLE ch_default.dreiecke_lv95_v OWNER TO SUPERADMIN;
GRANT SELECT ON TABLE ch_default.dreiecke_lv95_v TO USER;
