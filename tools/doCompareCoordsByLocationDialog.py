...
from Ui_comparecoordsbylocation import Ui_CompareCoordsByLocation
import os, sys
import utils
import locale

class CompareCoordsByLocationDialog(QDialog, Ui_CompareCoordsByLocation):
    ...
    def __init__(self, parent):
        ...
        self.searchRadius = float(self.settings.value("gui/searchradius", 1).toFloat()[0])
    ...
    def initGui(self):
        ...
        self.dsbSearchRadius.setValue(self.searchRadius)
    ...
    def accept(self):
        ...
        self.settings.setValue("gui/searchradius",  QVariant(self.dsbSearchRadius.value()))        
...
#            return   
            ...
            self.emit( SIGNAL("okClickedCopyCoordsByLocation(QString, QString, QString, QString, double, bool)"), self.cbLayerA.currentText(), self.cbLayerB.currentText(), self.cbIdA.currentText(), self.cbIdB.currentText(), self.dsbSearchRadius.value(), self.checkBoxAddLayerToMap.isChecked())
